...
function do_guess() {
    ...
    //working to here
            ...
            guess_list.push(guess);
            // console.log(guess_list.length)

            let guess_list_set_check_high = [...new Set(guess_list)];
            ...
            if (guess_list_set_check_high.length != guess_list.length) {
                range_success_message.innerHTML = `You already guessed ${guess_number}. Try a new number.`;
            }
    ...
    // }
        ...
        let guess_list_set_check = [...new Set(guess_list)];
        // console.log(guess_list_set_check)
        // console.log(guess_list_set_check.length)
        // console.log(guess_list_set_check.length != guess_list.length)
        if (guess_list_set_check.length != guess_list.length) {
            range_success_message.innerHTML = `You already guessed ${guess_number}. Try a new number.`;
        }
