...
function do_guess() {
    ...
    //working to here
        ...
        if (flag == true) {
            ...
            range_success_message3.innerHTML = `You already guessed ${guess_number}. Try a new number.`;
        }    

        else {
            console.log('we hit line 110');
            guess_list.push(guess);
            range_success_message3.innerHTML = `${guess_number} is too high. Try a lower number.`;
            }
        }
        ...
        if (flag == true) {
            ...
            guess_list.push(guess);
            range_success_message3.innerHTML = `${guess_number} is too low. Try a higher number.`;
            }
        }
